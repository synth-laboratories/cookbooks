#!/bin/bash
# GEPA Prompt Optimization via CLI
#
# This script runs GEPA prompt optimization using the CLI.
#
# Prerequisites:
...
#
# Options:
#   - Edit configs/gepa.toml to change optimization parameters
...
# Config path
CONFIG_PATH="$COOKBOOK_DIR/configs/gepa.toml"
